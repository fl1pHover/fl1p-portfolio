    ...
    <section className="padding-bigger">
      <div className="padding-inner">
        <div className="relative">
          ...
          <motion.div variants={fadeIn} initial="hidden" animate="visible" className="lg:px-[3rem] lg:pr-[1em] grid lg:grid-cols-3 h-full items-start relative">
            <div className="col-span-1 relative p-6 sticky top-7 left-0 py-[7em] hidden lg:block">
              <div className="w-full aspect-square rounded-lg relative">
                <div className="size-full bg-red-500" style={{ clipPath: "polygon(99% 0, 99% 6%, 100% 7%, 100% 100%, 6% 100%, 0 94%, 0 0)" }}></div>
                <Label size={"xs"} className="absolute -rotate-90 bottom-0 -left-4 origin-left text-foreground-secondary z-20">
                  IMAGE_356
                </Label>
              </div>
            </div>
            <div className="col-span-2 relative size-full p-6 py-[7em]">
              ...
              <div className="py-[0.5em] col-span-full text-center lg:text-left">
                <SplitText text="Call me" className="bro-header leading-none" />
              ...
              <div className="flex items-center text-foreground justify-between gap-2">
                ...
                <Label size={"xs"} className="bg-background text-nowrap font-bold">
                  Newbie Graduated Student
                </Label>
              </div>
              </div>

              <h1 className="text-base lg:text-2xl font-medium">Мэдээллийн системийн бакалавр боловсролтой, Frontend хөгжүүлэгчээр ажиллах сонирхолтой. Front-End Developer, UI/UX Designer зэрэг албан тушаалд төслүүд дээр амжилттай ажилласан туршлатай. Вэб хөгжүүлэлт, дизайны чиглэлд сонирхолтой бөгөөд шинэ технологиудыг хурдан сурах чадвартай. Багаар ажиллах, асуудал шийдвэрлэх, цагийн менежмент зэрэг ур чадваруудтай. Хариуцлагатай, дасан зохицох чадвартай. Мэргэжлийн ур чадвараа хөгжүүлэхийн тулд тасралтгүй суралцаж, шинэ мэдлэгийг эзэмшихийг зорьдог.</h1>
            </div>
          </motion.div>
        </div>
        <div className="border border-r-0 relative">
          <div className="p-4 py-10 pt-[5em]">
            <SplitText text="Education And" className="bro-header leading-none lg:leading-normal" />
            <SplitText text="Certifications" className="bro-header lg:pl-10 leading-none lg:leading-normal" />
          </div>
          <div
